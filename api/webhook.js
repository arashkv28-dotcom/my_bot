export default async function handler(req, res) {
  ...
  // ==========================================
  // 🧠 بخش سوم: هوش مصنوعی جمینای (آپدیت مدل به gemini-pro)
  // ==========================================
  if (text.startsWith("رباتی")) {
    ...
    if (userPrompt.length > 0) {
      ...
      try {
        ...
        // تغییر ورژن به gemini-pro (پایدارترین مدل)
